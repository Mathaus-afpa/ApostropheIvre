...
<div class="sidebar flex-col fixed top-0 bottom-0 lg:left-0 mr-3 mt-3 mb-3 p-2 w-64 overflow-y-auto bg-green-500 rounded-r-xl shadow-lg shadow-gray-500">

  <div class=" flex justify-center">
    <svg class="w-32" xmlns="http://www.w3.org/2000/svg" version="1.0" width="190.000000pt" height="180.000000pt"
  ...
  <a href="${pageContext.request.contextPath}/accueil">
    ...
    <div class="p-2 pl-20 flex justify-start items-center bg-green-500 gap-3 hover:bg-green-600 hover:border-r-2 hover:border-r-white">
  ...
  <a href="${pageContext.request.contextPath}/livres">
    ...
    <div class="p-2 pl-20 flex justify-start items-center bg-green-500 gap-3 hover:bg-green-600 hover:border-r-2 hover:border-r-white">
      <svg class="w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by
    @fontawesome -
    https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M575.8 255.5c0 18-15 32.1-32 32.1l-32 0 .7 160.2c0 2.7-.2 5.4-.5 8.1l0 16.2c0 22.1-17.9 40-40 40l-16 0c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1L416 512l-24 0c-22.1 0-40-17.9-40-40l0-24 0-64c0-17.7-14.3-32-32-32l-64 0c-17.7 0-32 14.3-32 32l0 64 0 24c0 22.1-17.9 40-40 40l-24 0-31.9 0c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2l-16 0c-22.1 0-40-17.9-40-40l0-112c0-.9 0-1.9 .1-2.8l0-69.7-32 0c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z"/></svg>
      <span>Livres</span>
    </div>
  ...
  <a href="${pageContext.request.contextPath}/connexion">
    ...
    <div class="p-2 pl-20 flex justify-start items-center bg-green-500 gap-3 hover:bg-green-600 hover:border-r-2 hover:border-r-white">
      <svg class="w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by
    @fontawesome -
    https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M217.9 105.9L340.7 228.7c7.2 7.2 11.3 17.1 11.3 27.3s-4.1 20.1-11.3 27.3L217.9 406.1c-6.4 6.4-15 9.9-24 9.9c-18.7 0-33.9-15.2-33.9-33.9l0-62.1L32 320c-17.7 0-32-14.3-32-32l0-64c0-17.7 14.3-32 32-32l128 0 0-62.1c0-18.7 15.2-33.9 33.9-33.9c9 0 17.6 3.6 24 9.9zM352 416l64 0c17.7 0 32-14.3 32-32l0-256c0-17.7-14.3-32-32-32l-64 0c-17.7 0-32-14.3-32-32s14.3-32 32-32l64 0c53 0 96 43 96 96l0 256c0 53-43 96-96 96l-64 0c-17.7 0-32-14.3-32-32s14.3-32 32-32z"/></svg>
      <span>Connexion</span>
    </div>
