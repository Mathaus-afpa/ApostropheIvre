...
<c:forEach var="auteur" items="${auteurs}">
    <tr class="border-b border-neutral-500 bg-gray-800 border-gray-200 hover:bg-gray-900">
        ...
        <td class="px-6 py-4">
            <a href="${pageContext.request.contextPath}/auteur?id=${auteur.id}" class="font-normal text-violet-500 tracking-wide hover:underline underline-offset-2">Afficher</a>
        </td>
