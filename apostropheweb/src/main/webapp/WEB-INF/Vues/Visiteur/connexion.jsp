...
<div class="rounded-b-lg w-[32rem] mt-56">
    <div class="p-8">
        ...
        <form method="POST" action="${pageContext.request.contextPath}/connexion" class="mt-8 space-y-6">
...
<%--            </div>--%>
    ...
    <div class="px-8 py-4 bg-gray-700 text-center rounded-xl">
        ...
        <a class="font-medium text-green-500 hover:text-green-400 hover:underline hover:underline-offset-4" href="${pageContext.request.contextPath}/inscription"
        >Créer un compte.</a>
    </div>
</div>