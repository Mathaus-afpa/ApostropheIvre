            ...
            <div>
                ...
                <div class="relative flex items-center">
                    <input name="login" id="login" type="text" required
                           class="text-white tracking-normal bg-zinc-500 border border-stone-800 w-full text-sm pl-4 pr-10 py-2.5 rounded-md outline-none focus:outline focus:outline-green-500 focus:outline-2 outline-offset-0 focus:transition-all ease-out focus:duration-300" placeholder="Entrer identifiant" />
                </div>
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    <input name="mail" id="mail" type="email" required
                           class="text-white tracking-normal bg-zinc-500 border border-stone-800 w-full text-sm pl-4 pr-10 py-2.5 rounded-md outline-none focus:outline focus:outline-green-500 focus:outline-2 outline-offset-0 focus:transition-all ease-out focus:duration-300" placeholder="Entrer email" />
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    <input name="password" id="password" type="password" required
                           class="text-white tracking-normal bg-zinc-500 border border-stone-800 w-full text-sm pl-4 pr-10 py-2.5 rounded-md outline-none focus:outline focus:outline-green-500 focus:outline-2 outline-offset-0 focus:transition-all ease-out focus:duration-300" placeholder="Entrer mot de passe" />
