...
<div
    ...
    <form action="${pageContext.request.contextPath}/inscription" method="POST" class="md:col-span-3 w-full py-6 px-6 sm:px-16 max-md:max-w-xl mx-auto" >
...
<%--            </div>--%>
        ...
        <p class="text-gray-600 text-sm mt-6 text-center">Déjà membre ? <a href="${pageContext.request.contextPath}/connexion"
