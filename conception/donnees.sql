...
VALUES
    ('lou.cnt@apostropheivre.com', 'Cnt', 'Lou', 'Place Stanislas, 54000 Nancy', '54000', 'Nancy'),
    ('fab.gne@apostropheivre.com', 'Gne', 'Fab', 'Parc de la Pépinière, 54000 Nancy', '54000', 'Nancy'),
    ('ann.slm@apostropheivre.com', 'Slm', 'Ann', 'Place de la Carrière, 54000 Nancy', '54000', 'Nancy'),
    ('mat.hru@apostropheivre.com', 'Hru', 'Mat', 'Musée des Beaux-Arts, 54000 Nancy', '54000', 'Nancy'),
    ('elise.dupont@apostropheivre.com', 'Dupont', 'Elise', 'Place de la République, 54000 Nancy', '54000', 'Nancy'),
    ('jean.martin@apostropheivre.com', 'Martin', 'Jean', 'Parc de la Pépinière, 54000 Nancy', '54000', 'Nancy'),
    ('pierre.lenoir@apostropheivre.com', 'Lenoir', 'Pierre', 'Porte de la Craffe, 54000 Nancy', '54000', 'Nancy'),
    ('lucie.brunet@apostropheivre.com', 'Brunet', 'Lucie', 'Place de l\'Étoile, 54000 Nancy', '54000', 'Nancy'),
    ('marc.durand@apostropheivre.com', 'Durand', 'Marc', 'Place des Vosges, 54000 Nancy', '54000', 'Nancy'),
    ('sophie.lemoine@apostropheivre.com', 'Lemoine', 'Sophie', 'Boulevard Joffre, 54000 Nancy', '54000', 'Nancy'),
    ('nicolas.martel@apostropheivre.com', 'Martel', 'Nicolas', 'Place de l\'Alliance, 54000 Nancy', '54000', 'Nancy'),
    ('manon.petit@apostropheivre.com', 'Petit', 'Manon', 'Rue des Tiercelins, 54000 Nancy', '54000', 'Nancy'),
    ('olivier.morand@apostropheivre.com', 'Morand', 'Olivier', 'Place Dombasle, 54000 Nancy', '54000', 'Nancy'),
    ('christine.roux@apostropheivre.com', 'Roux', 'Christine', 'Rue Saint-Dizier, 54000 Nancy', '54000', 'Nancy'),
    ('michel.morel@apostropheivre.com', 'Morel', 'Michel', 'Place Carnot, 54000 Nancy', '54000', 'Nancy'),
    ('audrey.bellamy@apostropheivre.com', 'Bellamy', 'Audrey', 'Quai Sainte-Catherine, 54000 Nancy', '54000', 'Nancy'),
    ('louis.grand@apostropheivre.com', 'Grand', 'Louis', 'Place des Chartriers, 54000 Nancy', '54000', 'Nancy');
